...
function WorkContent() {
  ...
  const projects = [
    ...
    {
      title: t('work.cmp2204.title'),
      description: t('work.cmp2204.description'),
      image: null,
      technologies: ['java', 'socket programming', 'p2p networking'],
      liveUrl: null,
      githubUrl: 'https://github.com/tugaep/CMP2204Project',
      featured: false,
      category: 'academic'
    },
    {
      title: t('work.educationalapp.title'),
      description: t('work.educationalapp.description'),
      image: null,
      technologies: ['android', 'java', 'sqlite'],
      liveUrl: null,
      githubUrl: 'https://github.com/KaeideN/educational-kid-app',
      featured: false,
      category: 'academic'
    },
    {
      title: t('work.jambot.title'),
      description: t('work.jambot.description'),
      image: null,
      technologies: ['python', 'discord api', 'sqlite'],
      liveUrl: null,
      githubUrl: 'https://github.com/tugaep/OnlineGameJamBot',
      featured: false,
      category: 'bot'
    },
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero Section */}
      <section className="pt-32 pb-20 bg-gradient-to-br from-background to-primary-50/30 dark:to-primary-900/10">
          ...
          <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <div className="grid gap-8 max-w-6xl mx-auto mb-20">
              {featuredProjects.map((project, index) => (
                ...
                >
                  <Card className={`overflow-hidden hover-lift group border-primary-100 dark:border-primary-800 lg:grid lg:grid-cols-2 lg:gap-0 ${index % 2 === 1 ? 'lg:grid-flow-col-dense' : ''}`}>
                    {/* Project Image */}
                    ...
                    <CardContent className={`p-8 lg:p-12 flex flex-col justify-center ${
                      ...
                      <div className="flex flex-wrap gap-4">
                        {project.liveUrl && (
                          ...
                          >
                            <a href={project.liveUrl} target="_blank" rel="noopener noreferrer">
                              {t('work.visitSite')} {project.title === t('work.orbit.title') ? 'orbitapp.tech' : 'unog.dev'}
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
              {otherProjects.map((project, index) => (
                ...
                >
                  <Card className="h-full hover-lift group border-primary-100 dark:border-primary-800">
                    <CardContent className="p-6 flex flex-col h-full">
                      <div className="flex items-start justify-between mb-4">
                        ...
                        {project.githubUrl && project.githubUrl !== '#' && (
                          <Button
                            size="sm"
                            variant="outline"
                            className="border-primary-200 dark:border-primary-700 text-primary hover:bg-primary hover:text-primary-foreground transition-all duration-200 p-2"
                            asChild
                          >
                      ...
                      <div className="flex flex-wrap gap-2 mt-auto">
                        {project.technologies.map((tech) => (
                          <span 
                            key={tech}
                            className="px-2 py-1 bg-primary-50 dark:bg-primary-900/50 text-primary text-xs font-medium rounded border border-primary-100 dark:border-primary-700"
                          >
                            {tech}
                          </span>
                        ))}
